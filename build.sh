...
if [ "$1" == "" ]; then
	...
	BUILD_DEKTEC=0
	BUILD_VEGA3311=1
elif [ "$1" == "vid.obe.4.1.5" ]; then
	OBE_TAG=vid.obe.4.1.5
	LIBKLVANC_TAG=vid.obe.1.10.0
	LIBKLSCTE35_TAG=vid.obe.1.3.0
	LIBMPEGTS_TAG=hevc-dev
	BUILD_X265=1
	...
	BUILD_DEKTEC=0
	BUILD_VEGA3311=1
elif [ "$1" == "vid.obe.4.2.1" ]; then
	OBE_TAG=vid.obe.4.2.1
	LIBKLVANC_TAG=vid.obe.1.10.0
	LIBKLSCTE35_TAG=vid.obe.1.3.0
	LIBMPEGTS_TAG=hevc-dev
	BUILD_X265=1
	...
	BUILD_LIBLTNSDI=1
	LIBLTNSDI_TAG=master
elif [ "$1" == "vid.obe.4.4.1" ]; then
	OBE_TAG=vid.obe.4.4.1
	LIBKLVANC_TAG=vid.obe.1.10.0
	LIBKLSCTE35_TAG=vid.obe.1.3.0
	LIBMPEGTS_TAG=hevc-dev
	BUILD_X265=1
	...
	BUILD_LIBLTNSDI=1
	LIBLTNSDI_TAG=master
elif [ "$1" == "vid.obe.4.4.2" ]; then
	OBE_TAG=vid.obe.4.4.2
	LIBKLVANC_TAG=vid.obe.1.10.0
	LIBKLSCTE35_TAG=vid.obe.1.3.0
	LIBMPEGTS_TAG=hevc-dev
	BUILD_X265=1
	...
	BUILD_LIBLTNSDI=1
	LIBLTNSDI_TAG=master
elif [ "$1" == "vid.obe.4.5.1" ]; then
	OBE_TAG=vid.obe.4.5.1
	LIBKLVANC_TAG=vid.obe.1.10.0
	LIBKLSCTE35_TAG=vid.obe.1.3.0
	LIBMPEGTS_TAG=hevc-dev
	BUILD_X265=1
	...
	BUILD_LIBLTNSDI=1
	LIBLTNSDI_TAG=master
elif [ "$1" == "vid.obe.4.5.2" ]; then
	OBE_TAG=vid.obe.4.5.2
	LIBKLVANC_TAG=vid.obe.1.10.0
	LIBKLSCTE35_TAG=vid.obe.1.3.0
	LIBMPEGTS_TAG=hevc-dev
	BUILD_X265=1
	...
	BUILD_LIBLTNSDI=1
	LIBLTNSDI_TAG=master
elif [ "$1" == "vid.obe.4.6.1" ]; then
	OBE_TAG=vid.obe.4.6.1
	LIBKLVANC_TAG=vid.obe.1.10.0
	LIBKLSCTE35_TAG=vid.obe.1.3.0
	LIBMPEGTS_TAG=hevc-dev
	BUILD_X265=1
	...
	BUILD_LIBLTNSDI=1
	LIBLTNSDI_TAG=master
elif [ "$1" == "vid.obe.4.7.3" ]; then
	OBE_TAG=vid.obe.4.7.3
	LIBKLVANC_TAG=vid.obe.1.10.0
	LIBKLSCTE35_TAG=vid.obe.1.3.0
	LIBMPEGTS_TAG=hevc-dev
	BUILD_X265=1
